...
('Stage 1', 'The Digital Spark & Movement Genesis', 'May – Early June 2026', 'Triggered by controversial institutional remarks comparing unemployed youth to "parasites and cockroaches," digital strategist Abhijeet Dipke founds the satirical Cockroach Janta Party (CJP). What starts as an online reaction virally mobilizes millions of Gen-Z and millennial students over systemic exam leaks (NEET-UG, CBSE), culminating in the movement''s first major physical sit-in at Jantar Mantar on June 6, 2026.', 'destructive', 1),
