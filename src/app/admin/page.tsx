...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    const loadMockSubmissions = () => {
      setSubmissions([
        { id: '1', city: 'Lucknow', district: null, state: 'Uttar Pradesh', country: 'India', latitude: 26.8467, longitude: 80.9462, participation_status: 'supporting', attendance: 'planning_to_attend', support_reason: 'We want transparency and accountability in governance.', desired_outcome: 'An independent oversight board.', age_group: '25-34', occupation: 'Software Engineer', status: 'pending', created_at: new Date(Date.now() - 3600000).toISOString(), submission_hash: 'mock_hash' },
        { id: '2', city: 'Delhi', district: null, state: 'Delhi', country: 'India', latitude: 28.7041, longitude: 77.1025, participation_status: 'participating', attendance: 'already_attended', support_reason: 'I simply want answers to our basic questions.', desired_outcome: 'Direct dialog with the organizers.', age_group: '18-24', occupation: 'Student', status: 'pending', created_at: new Date(Date.now() - 7200000).toISOString(), submission_hash: 'mock_hash' },
        { id: '3', city: 'Kanpur', district: null, state: 'Uttar Pradesh', country: 'India', latitude: 26.4499, longitude: 80.3319, participation_status: 'supporting', attendance: 'supporting_online', support_reason: 'Our concerns deserve attention and action, not deflection.', desired_outcome: 'Formal response to the memorandum.', age_group: '35-44', occupation: 'Teacher', status: 'pending', created_at: new Date(Date.now() - 10800000).toISOString(), submission_hash: 'mock_hash' },
        { id: '4', city: 'Mumbai', district: null, state: 'Maharashtra', country: 'India', latitude: 19.076, longitude: 72.8777, participation_status: 'supporting', attendance: 'planning_to_attend', support_reason: 'Peaceful protest is the bedrock of democracy.', desired_outcome: 'Protection of civil liberties.', age_group: '25-34', occupation: 'Designer', status: 'approved', created_at: new Date(Date.now() - 14400000).toISOString(), submission_hash: 'mock_hash' },
        { id: '5', city: 'Bangalore', district: null, state: 'Karnataka', country: 'India', latitude: 12.9716, longitude: 77.5946, participation_status: 'participating', attendance: 'already_attended', support_reason: 'To show solidarity with the movement and raise awareness.', desired_outcome: 'Policy reforms and revisions.', age_group: '18-24', occupation: 'Student', status: 'hidden', created_at: new Date(Date.now() - 18000000).toISOString(), submission_hash: 'mock_hash' }
      ]);
    };
